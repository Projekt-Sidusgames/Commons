...
/**
 * DateParser is the "missing" interface for the parsing methods of {@link java.text.DateFormat}. You can obtain an object implementing this interface by using one of the FastDateFormat factory methods.
 * <p>
...
public interface DateParser {
  ...
  /**
   * Parses a formatted date string according to the format.  Updates the Calendar with parsed fields. Upon success, the ParsePosition index is updated to indicate how much of the source text was consumed. Not all source text needs to be consumed.
