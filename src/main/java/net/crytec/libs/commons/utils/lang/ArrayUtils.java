...
import net.crytec.libs.commons.utils.lang.mutable.MutableInt;
 ...
 * An exception will not be thrown for a {@code null} array input. However, an Object array that contains a {@code null} element may throw an exception. Each method documents its behaviour.
 *
 * <p>#ThreadSafe#
 *
 * @since 2.0
...
public class ArrayUtils {
   ...
   * array plus the given element on the specified position. The component type of the returned array is always the same as that of the input array.
   *
   * <p>If the input array is {@code null}, a new one element array is returned
   * whose component type is the same as the element.
   *
   ...
   * @deprecated this method has been superseded by {@link #insert(int, boolean[], boolean...)} and may be removed in a future release. Please note the handling of {@code null} input arrays differs in the new method: inserting {@code X} into a {@code
   ...
   * @return A new array containing the existing elements and the new element
   * @throws IndexOutOfBoundsException if the index is out of range (index &lt; 0 || index &gt; array.length).
   * @deprecated this method has been superseded by {@link #insert(int, byte[], byte...)} and may be removed in a future release. Please note the handling of {@code null} input arrays differs in the new method: inserting {@code X} into a {@code null}
   ...
   * @return A new array containing the existing elements and the new element
   * @throws IndexOutOfBoundsException if the index is out of range (index &lt; 0 || index &gt; array.length).
   * @deprecated this method has been superseded by {@link #insert(int, char[], char...)} and may be removed in a future release. Please note the handling of {@code null} input arrays differs in the new method: inserting {@code X} into a {@code null}
   * array results in {@code null} not {@code X}.
   */
  @Deprecated
   ...
   * @return A new array containing the existing elements and the new element
   * @throws IndexOutOfBoundsException if the index is out of range (index &lt; 0 || index &gt; array.length).
   * @deprecated this method has been superseded by {@link #insert(int, double[], double...)} and may be removed in a future release. Please note the handling of {@code null} input arrays differs in the new method: inserting {@code X} into a {@code
   * null} array results in {@code null} not {@code X}.
   */
  @Deprecated
   ...
   * @return A new array containing the existing elements and the new element
   * @throws IndexOutOfBoundsException if the index is out of range (index &lt; 0 || index &gt; array.length).
   * @deprecated this method has been superseded by {@link #insert(int, float[], float...)} and may be removed in a future release. Please note the handling of {@code null} input arrays differs in the new method: inserting {@code X} into a {@code
   * null} array results in {@code null} not {@code X}.
   */
  @Deprecated
   ...
   * @return A new array containing the existing elements and the new element
   * @throws IndexOutOfBoundsException if the index is out of range (index &lt; 0 || index &gt; array.length).
   * @deprecated this method has been superseded by {@link #insert(int, int[], int...)} and may be removed in a future release. Please note the handling of {@code null} input arrays differs in the new method: inserting {@code X} into a {@code null}
   * array results in {@code null} not {@code X}.
   */
  @Deprecated
   ...
   * @return A new array containing the existing elements and the new element
   * @throws IndexOutOfBoundsException if the index is out of range (index &lt; 0 || index &gt; array.length).
   * @deprecated this method has been superseded by {@link #insert(int, long[], long...)} and may be removed in a future release. Please note the handling of {@code null} input arrays differs in the new method: inserting {@code X} into a {@code null}
   * array results in {@code null} not {@code X}.
   */
  @Deprecated
   ...
   * @return A new array containing the existing elements and the new element
   * @throws IndexOutOfBoundsException if the index is out of range (index &lt; 0 || index &gt; array.length).
   * @deprecated this method has been superseded by {@link #insert(int, short[], short...)} and may be removed in a future release. Please note the handling of {@code null} input arrays differs in the new method: inserting {@code X} into a {@code
   * null} array results in {@code null} not {@code X}.
   */
  @Deprecated
   ...
   * @deprecated this method has been superseded by {@link #insert(int, Object[], Object...) insert(int, T[], T...)} and may be removed in a future release. Please note the handling of {@code null} input arrays differs in the new method: inserting
   * {@code X} into a {@code null} array results in {@code null} not {@code X}.
   */
  @Deprecated
   ...
   *
   * <p>If the input array is {@code null}, a new one element array is returned
   * whose component type is the same as the element, unless the element itself is null, in which case the return type is Object[]
   *
   * <pre>
   ...
   * @return A new array containing the existing elements plus the new element The returned array type will be that of the input array (unless null), in which case it will have the same type as the element. If both are null, an
   ...
   * @param array   the array to "add" the element to, may be {@code null}.
   * @param element the object to add.
   * @return A new array containing the existing elements plus the new element The returned array type will be that of the input array (unless null), in which case it will have the same type as the element.
   * @since 3.10
   */
   ...
   * given array.  If the array contains a value within the inclusive range defined by (value - tolerance) to (value + tolerance).
   *
...
//  }
   ...
   * This method will return the index of the first value which falls between the region defined by valueToFind - tolerance and valueToFind + tolerance.
   *
   * <p>This method returns {@link #INDEX_NOT_FOUND} ({@code -1}) for a {@code null} input array.
   *
   * @param array       the array to search through for the object, may be {@code null}
...
//        }
   ...
   * specified array. All subsequent elements are shifted to the left (subtracts one from their indices). If the array doesn't contains such an element, no elements are removed from the array.
   *
   * <p>This method returns a new array with the same elements of the input
   ...
   * from the specified array. All subsequent elements are shifted left. For any element-to-be-removed specified in greater quantities than contained in the original array, no change occurs beyond the removal of the existing matching items.
   *
   * <p>This method returns a new array with the same elements of the input
   * array except for the earliest-encountered occurrences of the specified elements. The component type of the returned array is always the same as that of the input array.
   *
   * <pre>
   ...
   * @return A new array containing the existing elements except the earliest-encountered occurrences of the specified elements.
   * @since 3.0.1
   */
   ...
   * @param endIndexExclusive   elements up to endIndex-1 are present in the returned subarray. Undervalue (&lt; startIndex) produces empty array, overvalue (&gt;array.length) is demoted to array length.
   ...
   * for overflow indices. Negative indices are promoted to 0(zero). If any of the sub-arrays to swap falls outside of the given array, then the swap is stopped at the end of the array and as many as possible elements are swapped.</p>
   * <p>
   * Examples:
   * <ul>
   ...
   * compiler can deduce the type of the array itself. While it is possible to select the type explicitly like in {@code Number[] array = ArrayUtils.&lt;Number&gt;toArray(Integer.valueOf(42), Double.valueOf(Math.PI))}, there is no real advantage when
   * compared to {@code new Number[] {Integer.valueOf(42), Double.valueOf(Math.PI)}}.
   *
