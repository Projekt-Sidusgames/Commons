 ...
 * An exception will not be thrown for a {@code null} input. Each method documents its behaviour in more detail.</p>
 *
 * <p>#ThreadSafe#</p>
 *
 * @since 2.0
...
public class BooleanUtils {
   ...
   * (case insensitive) will return {@code true}. {@code 'false'}, {@code 'off'}, {@code 'n'}, {@code 'f'} or {@code 'no'} (case insensitive) will return {@code false}. Otherwise, {@code null} is returned.</p>
   *
   * <p>NOTE: This returns null and will throw a NullPointerException if unboxed to a boolean. </p>
   *
   * <pre>
