...
public class NumberUtils {
  ...
  /**
   * Convert a {@code BigDecimal} to a {@code BigDecimal} with a scale of two that has been rounded using {@code RoundingMode.HALF_EVEN}. If the supplied {@code value} is null, then {@code BigDecimal.ZERO} is returned.
   *
  ...
  /**
   * Convert a {@code BigDecimal} to a {@code BigDecimal} whose scale is the specified value with a {@code RoundingMode} applied. If the input {@code value} is {@code null}, we simply return {@code BigDecimal.ZERO}.
   *
   * @param value        the {@code BigDecimal} to convert, may be null.
  ...
  /**
   * Convert a {@code Float} to a {@code BigDecimal} with a scale of two that has been rounded using {@code RoundingMode.HALF_EVEN}. If the supplied {@code value} is null, then {@code BigDecimal.ZERO} is returned.
   *
   * <p>Note, the scale of a {@code BigDecimal} is the number of digits to the right of the
   * decimal point.</p>
   *
  ...
  /**
   * Convert a {@code Float} to a {@code BigDecimal} whose scale is the specified value with a {@code RoundingMode} applied. If the input {@code value} is {@code null}, we simply return {@code BigDecimal.ZERO}.
   *
   * @param value        the {@code Float} to convert, may be null.
   * @param scale        the number of digits to the right of the decimal point.
   * @param roundingMode a rounding behavior for numerical operations capable of discarding precision.
  ...
  /**
   * Convert a {@code Double} to a {@code BigDecimal} with a scale of two that has been rounded using {@code RoundingMode.HALF_EVEN}. If the supplied {@code value} is null, then {@code BigDecimal.ZERO} is returned.
   *
   * <p>Note, the scale of a {@code BigDecimal} is the number of digits to the right of the
   * decimal point.</p>
   *
  ...
  /**
   * Convert a {@code Double} to a {@code BigDecimal} whose scale is the specified value with a {@code RoundingMode} applied. If the input {@code value} is {@code null}, we simply return {@code BigDecimal.ZERO}.
   *
   * @param value        the {@code Double} to convert, may be null.
   * @param scale        the number of digits to the right of the decimal point.
   * @param roundingMode a rounding behavior for numerical operations capable of discarding precision.
  ...
  /**
   * Convert a {@code String} to a {@code BigDecimal} with a scale of two that has been rounded using {@code RoundingMode.HALF_EVEN}. If the supplied {@code value} is null, then {@code BigDecimal.ZERO} is returned.
   *
   * <p>Note, the scale of a {@code BigDecimal} is the number of digits to the right of the
   * decimal point.</p>
   *
  ...
  /**
   * Convert a {@code String} to a {@code BigDecimal} whose scale is the specified value with a {@code RoundingMode} applied. If the input {@code value} is {@code null}, we simply return {@code BigDecimal.ZERO}.
   *
   * @param value        the {@code String} to convert, may be null.
   * @param scale        the number of digits to the right of the decimal point.
   * @param roundingMode a rounding behavior for numerical operations capable of discarding precision.
   ...
   * will be interpreted as a hexadecimal Integer - or Long, if the number of digits after the prefix is more than 8 - or BigInteger if there are more than 16 digits.
   * </p>
   * <p>Then, the value is examined for a type qualifier on the end, i.e. one of
   * {@code 'f', 'F', 'd', 'D', 'l', 'L'}.  If it is found, it starts trying to create successively larger types from the type specified until one is found that can represent the value.</p>
   *
   * <p>If a type specifier is not found, it will check for a decimal point
   * and then try successively larger types from {@code Integer} to {@code BigInteger} and from {@code Float} to {@code BigDecimal}.</p>
   *
   * <p>
   ...
   * hex (0xhhhh) and octal (0dddd) notations. N.B. a leading zero means octal; spaces are not trimmed.</p>
   *
   * <p>Returns {@code null} if the string is {@code null}.</p>
   *
   * @param str a {@code String} to convert, may be null
   ...
   * since 3.1 it handles hex (0Xhhhh) and octal (0ddd) notations. N.B. a leading zero means octal; spaces are not trimmed.</p>
   *
   * <p>Returns {@code null} if the string is {@code null}.</p>
   *
   * @param str a {@code String} to convert, may be null
   ...
   * {@code 0X} qualifier, octal numbers, scientific notation and numbers marked with a type qualifier (e.g. 123L).</p>
   *
   * <p>Non-hexadecimal strings beginning with a leading zero are
   * treated as octal values. Thus the string {@code 09} will return {@code false}, since {@code 9} is not a valid octal value. However, numbers beginning with {@code 0.} are treated as decimal.</p>
   *
   ...
   * {@link Long#parseLong(String)}, {@link Float#parseFloat(String)} or {@link Double#parseDouble(String)}. This method can be used instead of catching {@link java.text.ParseException} when calling one of those methods.</p>
   *
