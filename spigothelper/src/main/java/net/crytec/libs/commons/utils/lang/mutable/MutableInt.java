...
import net.crytec.libs.commons.utils.lang.NumberUtils;
...
public class MutableInt extends Number implements Comparable<MutableInt>, Mutable<Number> {
  ...
  /**
   * Compares this object to the specified object. The result is {@code true} if and only if the argument is not {@code null} and is a {@code MutableInt} object that contains the same {@code int} value as this object.
   *
