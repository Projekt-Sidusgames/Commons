 ...
 * {@code SimpleDateFormat} in most parsing situations. This class is especially useful in multi-threaded server environments. {@code SimpleDateFormat} is not thread-safe in any JDK version, nor will it be as Sun has closed the
...
public class FastDateParser implements DateParser, Serializable {
  ...
  /**
   * This implementation updates the ParsePosition if the parse succeeds. However, it sets the error index to the position before the failed field unlike the method {@link java.text.SimpleDateFormat#parse(String, ParsePosition)} which sets the error
   * index to after the failed field.
   * <p>
  ...
  /**
   * Parse a formatted date string according to the format.  Updates the Calendar with parsed fields. Upon success, the ParsePosition index is updated to indicate how much of the source text was consumed. Not all source text needs to be consumed.
